...
graph TD
    ...
    style AI fill:#ffffff,stroke:#333333
    style ENCLAVE fill:#f5f5f5,stroke:#333333
    style MODULE fill:#ffffff,stroke:#333333
    style SAFE fill:#f5f5f5,stroke:#333333
    style PROTOCOLS fill:#ffffff,stroke:#333333
```
...
flowchart TD
    ...
    style READ fill:#ffffff,stroke:#333333
    style EVALUATE fill:#ffffff,stroke:#333333
    style DECIDE fill:#f5f5f5,stroke:#333333
    style REBALANCE fill:#ffffff,stroke:#333333
    style HOLD fill:#ffffff,stroke:#333333
    style MONITOR fill:#ffffff,stroke:#333333
    style CHECK fill:#f5f5f5,stroke:#333333
    style EXIT fill:#ffffff,stroke:#333333
```
