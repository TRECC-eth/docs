...
<div className="ecosystem-grid" aria-label="TRECC ecosystem integrations">
  ...
  <div className="ecosystem-node ecosystem-node-strk20">
    <span className="ecosystem-logo ecosystem-logo-strk20" aria-hidden="true">
      <img src="/images/strk20.png" alt="" />
    </span>
    <div>
      <div className="ecosystem-name">STRK20</div>
      <span>Agentic privacy & shielding</span>
    </div>
  </div>
...
| **Starknet / STARKs** | Underlying cryptographic proof infrastructure utilized to intercept probabilistic AI intents and mathematically verify them against risk parameters (deterministic guardrails) before execution. |
| **STRK20** | Starknet's privacy framework used to provision shielded treasury balances for AI agents, allowing them to execute private transfers and DeFi interactions without exposing on-chain footprints or trading logic to front-runners. |
