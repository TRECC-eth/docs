...
graph TD
    ...
    style REG fill:#111111,stroke:#ffffff,color:#ffffff
    style BIND fill:#000000,stroke:#ffffff,color:#ffffff
    style OP fill:#111111,stroke:#ffffff,color:#ffffff
    style SIGNER fill:#111111,stroke:#ffffff,color:#ffffff
    style WALLET fill:#111111,stroke:#ffffff,color:#ffffff
    style NFT fill:#000000,stroke:#ffffff,color:#ffffff
```
...
graph LR
    ...
    style LOW fill:#000000,stroke:#ffffff,color:#ffffff
    style MID fill:#111111,stroke:#ffffff,color:#ffffff
    style HIGH fill:#000000,stroke:#ffffff,color:#ffffff
    style ELITE fill:#111111,stroke:#ffffff,color:#ffffff
```
