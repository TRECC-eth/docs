...
graph TD
    ...
    style LOSS fill:#000000,stroke:#ffffff,color:#ffffff
    style C fill:#111111,stroke:#ffffff,color:#ffffff
    style SAFE1 fill:#000000,stroke:#ffffff,color:#ffffff
    style IF fill:#111111,stroke:#ffffff,color:#ffffff
    style SAFE2 fill:#000000,stroke:#ffffff,color:#ffffff
```
...
| **Automated liquidation** | Positions are automatically unwound before losses can breach the collateral threshold |
