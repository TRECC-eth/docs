...
graph LR
    ...
    style REPAY fill:#000000,stroke:#ffffff,color:#ffffff
    style LIQUIDATION fill:#111111,stroke:#ffffff,color:#ffffff
    style SCORE fill:#000000,stroke:#ffffff,color:#ffffff
```
...
flowchart TD
    ...
    style HEALTH fill:#111111,stroke:#ffffff,color:#ffffff
    style LIQ fill:#000000,stroke:#ffffff,color:#ffffff
    style EXIT fill:#111111,stroke:#ffffff,color:#ffffff
    style REPAY fill:#000000,stroke:#ffffff,color:#ffffff
    style DEDUCT fill:#111111,stroke:#ffffff,color:#ffffff
    style SLASH fill:#000000,stroke:#ffffff,color:#ffffff
```
