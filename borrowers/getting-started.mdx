...
flowchart TD
    ...
    style SCAN fill:#000000,stroke:#ffffff,color:#ffffff
    style BEST fill:#111111,stroke:#ffffff,color:#ffffff
    style MOVE fill:#000000,stroke:#ffffff,color:#ffffff
    ...
    style DERISK fill:#000000,stroke:#ffffff,color:#ffffff
```
